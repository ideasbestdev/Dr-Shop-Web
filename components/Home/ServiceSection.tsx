            ...
            <ul>
                <li>
                    <article className='wow slideInUp'>
                        <div><Image src={AssetsImages.oneStopIcon} alt="oneStopIcon" /></div>
                        <h1>One Stop-Shop</h1>
                ...
                <li>
                    <article data-wow-delay="0.3s" className='wow slideInUp'>
                        <div><Image src={AssetsImages.customerIcon} alt="customerIcon" /></div>
                ...
                <li>
                    <article data-wow-delay="0.6s" className='wow slideInUp'>
                        <div><Image src={AssetsImages.inventoryIcon} alt="inventoryIcon" /></div>
                ...
                <li>
                    <article data-wow-delay="0.9s" className='wow slideInUp'>
                        <div><Image src={AssetsImages.deliveryIcon} alt="deliveryIcon" /></div>
                        <h1>Delivery</h1>
