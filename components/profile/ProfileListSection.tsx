...
import { setCartTotal } from '@/statemangment/slice/globalSlice';
    ...
    return (
        <ProfileListSectionStyle selected={selected}>
            <ul>
                ...
                <li onClick={() => { renderChange(BillingAddressList, 5) }}><a><div className="image_container"><Image alt='address' src={AssetsImages.address} /></div>Billing Address</a></li>
