...
import { AddBillingAddressSection } from './AddBillingAddressSection';
...
export default function BillingAddressList() {
    ...
    async function setDefault(address: AddressModel) {
        ...
        const response = await userService.EditBillingAddress(address);
        if (response.success) {
            if (defaultAddress) {
    ...
    return (
        <>
            {
                selectedAddress ?
                    <AddBillingAddressSection setAddressList={setAddressList} selectedAddress={selectedAddress} setSelectedAddress={setSelectedAddress} />
                    :
