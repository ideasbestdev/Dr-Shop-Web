...
export function AddBillingAddressSection({ setShowPop, setAddressList, selectedAddress, setSelectedAddress }: Props) {
    ...
    const onSubmit: SubmitHandler<AddressModel> = async (data, e) => {
        ...
        if (selectedAddress?.id) {
            response = await userService.EditBillingAddress(data);
        } else {
            response = await userService.AddBillingAddress(data);
        }
        if (response.success) {
            if (e) {
                e.target.reset();
        ...
        <>
            <AddLocationSectionStyle>
                <form noValidate onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <SectionTitleStyle>{selectedAddress?.id ? "Edit Billing Address" : "Add New Billing Address"}</SectionTitleStyle>
