...
export function OrderSummaryDetailSection({ selectedProducts, delivery_charge, final_amount }: Props) {
    ...
    return (
        <OrderSummarySectionStyle>
            ...
            <ul>
                ...
                <li>
                    <h3>Shipping<span>{delivery_charge} USD</span></h3>
                </li>
                <li>
                    <h3>Total<span>{final_amount} USD</span></h3>
                </li>
            </ul>
