...
export const globalSlice = createSlice({
    ...
    reducers: {
        ...
        setSelectedBillingAddress: (state: Draft<typeof initialState>, action: PayloadAction<typeof initialState.selectedAddress>) => {
        ...
        setCartTotal: (state: Draft<typeof initialState>, action: PayloadAction<typeof initialState.cartTotal>) => {
            state.cartTotal = action.payload;
        },
    },
});

export const { setBreadcrumb, setCurrentPage, setFirstRequest, setUser, setVerificationPop, setSelectedProducts, setSelectedCard, setSelectedAddress, setCartTotal, setSelectedBillingAddress } = globalSlice.actions
